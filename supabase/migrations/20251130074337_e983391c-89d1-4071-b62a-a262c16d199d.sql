-- Modificar get_clinical_research_data_by_patient para mostrar historial completo del paciente
...
BEGIN
  ...
  all_patient_encounters AS (
    ...
    WHERE patient_id IN (SELECT patient_id FROM matching_patients)
  )
  SELECT 
    ed.patient_id,
    ed.patient_code,
