-- Crear nueva función get_doctor_activity_detail_v2 con procedure_type
-- La función original get_doctor_activity_detail permanece intacta

CREATE OR REPLACE FUNCTION public.get_doctor_activity_detail_v2(
  start_date text, 
  end_date text, 
